...
**Autorizacao e o `tracking_token`**, o mesmo que abre o acompanhamento e a
avaliacao: quem o tem foi quem fez o pedido. Sem login de proposito — pedido
de convidado e caso normal, e exigir conta aqui deixaria justamente o
convidado sem saida.
"""
