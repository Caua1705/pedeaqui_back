...
Nao ha bancada dentro do pacote, e a API nao serve nenhuma. A que existia
(`page.html`, em `/voice/test`) saiu em 24/08/2026; a viva esta em
`tools/bancada/` e sobe pelo `bancada.bat` da raiz — ver `COMO-RODAR.md`.
